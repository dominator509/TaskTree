...
## Current Verified State (additive v1.0.66)
...
| 1.0.66 | 2026-08-16 | Application DI now resolves AutoUpdater and BugReporter with TaskTreePaths-backed roots, app startup installs crash capture, Orchestrator verifies the audit chain before subscriptions with fail-open failure auditing, and refreshed 380-test evidence is recorded. |
