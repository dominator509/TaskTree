...
- Built-in SDK Code Coverage: 1,465/1,910 production source lines covered (76.70%) using `--collect:"Code Coverage"`; the ignored `TestResults/` artifact was converted to Cobertura for the production-source calculation.
