...
- Built-in SDK Code Coverage: 1,466/1,937 production source lines covered (75.68%) using `--collect:"Code Coverage"`; the ignored `TestResults/` artifact was converted to Cobertura for the production-source calculation after the dispatcher hardening.
