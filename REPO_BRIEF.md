...
- BugReporter queue state is encrypted through `ISecureStore`; delivered reports remain queryable for 7 days, failed reports for 30 days, and only pending reports are retried.
