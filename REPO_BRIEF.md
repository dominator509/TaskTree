...
- Post-v1.0.81 validation rerun: 415 non-live, non-performance tests passed; 7 performance tests passed; the last Live-inclusive baseline remains 415 passed plus 1 intentional desktop-metrics skip.
