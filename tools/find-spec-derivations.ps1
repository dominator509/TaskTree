...
$expected=[ordered]@{
 ...
 'SPEC-DERIVED-PHASE1G'=10;'SPEC-DERIVED-PHASE1G-MSG2'=6;'SPEC-DERIVED-PHASE1H'=4;'SPEC-DERIVED-PHASE2A'=5;'SPEC-DERIVED-PHASE2B'=8;'SPEC-DERIVED-PHASE2C'=6;'SPEC-DERIVED-PHASE2D'=4;'SPEC-DERIVED-PHASE2E'=10;'SPEC-DERIVED-PHASE2F'=8;'SPEC-DERIVED-PHASE2G'=11;'SPEC-DERIVED-PHASE3A'=7;'SPEC-DERIVED-PHASE3B'=9;'SPEC-DERIVED-PHASE3C'=7;'SPEC-DERIVED-PHASE3D'=10;'SPEC-DERIVED-PHASE3E'=14;'SPEC-DERIVED-PHASE3F'=3;'SPEC-DERIVED-PHASE4A'=1;'SPEC-DERIVED-PHASE4B'=1;'SPEC-DERIVED-PHASE4C'=0;'SPEC-DERIVED-PHASE4D'=0;'SPEC-DERIVED-PHASE5A'=0;'SPEC-DERIVED-PHASE5B'=0
}
